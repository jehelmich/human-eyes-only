...
- a runnable extractor, as a pull request against `benchmark/`. The extraction
  suite is not built yet ([ROADMAP.md](ROADMAP.md)), so the first such
  contribution starts it rather than slots into it;
